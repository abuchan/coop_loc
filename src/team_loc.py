  ...
  def __init__(self):
    ...
    while (not init):
      if rospy.is_shutdown():
        return
      elif (rospy.has_param('initial_state') & rospy.has_param('initial_covariance') & rospy.has_param('initial_time') &rospy.has_param('t_bias')):
    ...
    for ii in range(self.n):
      ...
      rospy.Subscriber(self.robot_prefix+self.robot_suffix[ii]+"/imu_moving", 
      ...
      rospy.Subscriber(self.robot_prefix+self.robot_suffix[ii]+"/camera_0/estimated_pose",
